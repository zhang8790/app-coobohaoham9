...
function FlowSvg() {
  return (
    <svg viewBox="0 0 940 360" style={{ width: '100%', height: 'auto', display: 'block' }} preserveAspectRatio="xMidYMid meet">
      ...
      <rect x="30" y="150" width="150" height="60" rx="10" fill="#111827" stroke="var(--warning)" strokeWidth={1.5} />
      <text x="105" y="178" textAnchor="middle" fill="#E5E7EB" fontSize={13} fontWeight={600}>订单全额</text>
      <text x="105" y="196" textAnchor="middle" fill="#9CA3AF" fontSize={11}>含金豆抵扣</text>
      ...
      <text x="665" y="244" textAnchor="middle" fill="#9CA3AF" fontSize={11}>返下单人金豆</text>
      ...
      <rect x="590" y="260" width="150" height="60" rx="10" fill="#0f172a" stroke="var(--warning)" strokeWidth={1.5} />
      <text x="665" y="284" textAnchor="middle" fill="var(--warning)" fontSize={12} fontWeight={700}>平台收入</text>
      <text x="665" y="304" textAnchor="middle" fill="#9CA3AF" fontSize={11}>平台让利 − 上面三项</text>
      <text x="770" y="92" fill="#9CA3AF" fontSize={11}>比例由段位/活跃/邀请新用户系数决定</text>
...
export default function CommissionGuide() {
  ...
  return (
    <div style={{ maxWidth: 980, margin: '0 auto' }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, color: '#E5E7EB', marginBottom: 4 }}>佣金规则说明</h1>
      <p style={{ color: '#9CA3AF', fontSize: 13, marginBottom: 24 }}>平台让利从哪来、分给谁、谁先锁客谁先拿 · 最后更新 {now}</p>
      ...
      <div style={card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          <div style={{ borderRadius: 14, padding: 18, border: '1px solid rgba(56,189,248,0.25)', background: 'rgba(56,189,248,0.06)' }}>
            ...
            <div style={{ fontSize: 13, margin: '6px 0' }}><span style={{ color: '#9CA3AF', display: 'inline-block', minWidth: 76 }}>佣金系统</span><span style={{ color: '#F87171', fontWeight: 700 }}>不读取 · 不发佣金</span></div>
          ...
          <div style={{ borderRadius: 14, padding: 18, border: '1px solid rgba(34,197,94,0.25)', background: 'rgba(34,197,93,0.06)' }}>
            ...
            <div style={{ fontSize: 13, margin: '6px 0' }}><span style={{ color: '#9CA3AF', display: 'inline-block', minWidth: 76 }}>佣金系统</span><span style={{ color: '#22C55E', fontWeight: 700 }}>唯一读取来源</span></div>
