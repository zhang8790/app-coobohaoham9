...
const 餐饮: CategoryEmotionProfile = {
  ...
  label: '餐饮美食',
  tone: '烟火人间，与人共食的妥帖',
  allowedMoodTags: ['舒心', '满足', '幸福', '温馨', '甜蜜', '愉悦', '分享', '用餐时光', '放松', '仪式感', '怀旧', '温暖'],
...
const 饮品: CategoryEmotionProfile = {
  ...
  label: '饮品',
  tone: '微醺与小憩，唇齿间的喘息',
  allowedMoodTags: ['甜蜜', '舒心', '放松', '愉悦', '清新', '清爽', '浪漫', '慢生活'],
...
const 烘焙: CategoryEmotionProfile = {
  ...
  label: '烘焙甜点',
  tone: '晨间手作的温度',
  allowedMoodTags: ['甜蜜', '舒心', '温馨', '幸福', '满足', '浪漫'],
  ...
  bodyTemplates: [
    ...
    `下午茶来一块{name}，配一杯热饮，{attr}比什么舒心系电影都管用——像{metaphor}，{realm}。`,
...
const 水果生鲜: CategoryEmotionProfile = {
  ...
  label: '水果生鲜',
  tone: '土地与时令的鲜活',
  allowedMoodTags: ['清爽', '清新', '自然', '纯净', '解暑', '舒心', '活力', '满足'],
...
const 零售: CategoryEmotionProfile = {
  ...
  label: '零售百货',
  tone: '悦己的小确幸与陪伴',
  allowedMoodTags: ['快乐', '满足', '惊喜', '舒心', '温馨', '可爱', '有趣', '浪漫', '甜蜜', '怀旧'],
...
const 美业: CategoryEmotionProfile = {
  ...
  label: '丽人美业',
  tone: '悦己与焕新的精致',
  allowedMoodTags: ['精致', '舒心', '放松', '浪漫', '甜蜜', '仪式感', '高端', '典雅'],
...
const 亲子: CategoryEmotionProfile = {
  ...
  label: '亲子',
  tone: '陪伴与成长的童真',
  allowedMoodTags: ['温馨', '幸福', '甜蜜', '舒心', '快乐', '可爱'],
...
const 生活服务: CategoryEmotionProfile = {
  ...
  label: '生活服务',
  tone: '省心与托付的安心',
  allowedMoodTags: ['放松', '舒心', '实用', '温馨', '安心'],
  ...
  bodyTemplates: [
    ...
    `预约一次{name}，{attr}回到家时一切都整整齐齐——那种"有人替你操心"的感觉太舒心了，像{metaphor}。`,
...
const 酒店民宿: CategoryEmotionProfile = {
  ...
  label: '酒店民宿',
  tone: '栖居与远方的慢生活',
  allowedMoodTags: ['放松', '舒心', '慢生活', '浪漫', '平静', '安逸', '温馨'],
