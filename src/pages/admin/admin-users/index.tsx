    ...
    <View className="min-h-screen bg-background pb-10">
      ...
      {loading ? (
        ...
        <View className="flex flex-col items-center justify-center py-20 gap-3">
          <Icon name="account-group" size={60} className="text-muted-foreground/40" />
            ...
            <View key={u.id} className="rounded-2xl bg-card border border-border p-4 flex flex-col gap-3">
              <View className="flex items-start justify-between">
                ...
                <View className="flex flex-col items-end">
                  ...
                  <Text className="text-base text-muted-foreground">健康豆 {Number(u.tb_balance ?? 0).toFixed(2)}</Text>
                </View>
              </View>
