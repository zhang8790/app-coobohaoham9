      ...
      <View className="mx-4 mt-4 p-4 bg-muted rounded-2xl">
        <View className="flex items-start gap-2">
          ...
          <View>
            ...
            <Text className="text-base text-muted-foreground leading-relaxed">• 使用健康豆抵扣部分将退还至健康豆余额</Text>
            <Text className="text-base text-muted-foreground leading-relaxed">• 退款对应的健康豆奖励将同步扣回</Text>
