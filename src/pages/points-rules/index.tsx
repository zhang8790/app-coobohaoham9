    ...
    <View className="min-h-screen bg-background pb-10">
      <View className="mx-4 mt-4 bg-card rounded-2xl border border-border p-4 text-muted-foreground text-sm leading-loose">
        ...
        <View className="mb-4">
          ...
          <Text className="block">1. 情绪豆：通用抵扣币，1 情绪豆 = 1 元，下单消费获赠、订单 1:1 抵扣。</Text>
        ...
        <View className="mb-4">
          ...
          <Text className="block">1. 情绪豆：完成订单按段位比例获赠，部分订单支付时 1:1 抵扣现金。</Text>
        ...
        <View className="mb-4">
          ...
          <Text className="block">1. 情绪豆、情绪豆均为平台内资产，不可提现、不可兑现金、不可二级转让。</Text>
        ...
        <View className="mb-4">
          ...
          <Text className="block">1. 订单退款时，获赠情绪豆与已确权发放将按规则相应扣回。</Text>
