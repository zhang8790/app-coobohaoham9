...
const NEED_MAP: Record<SceneKey, NeedDef> = {
  ...
  immunity: {
    key: 'immunity', label: '增强免疫', icon: '💪',
    title: '增强免疫 · 体质之选', subTitle: '为免疫力偏低人群优选温补食养好物',
    crowds: [toCrowd('免疫力低')], preferTags: ['补气养血'],
  },
  children: {
    key: 'children', label: '儿童成长', icon: '👶',
    title: '儿童成长 · 营养之选', subTitle: '为成长发育挑选，注意核对配料表',
    crowds: [], preferTags: ['补气养血', '健脾养胃'],
    note: '儿童食养参考，请家长核对配料表与适龄性',
  },
  sugar: {
    key: 'sugar', label: '控糖饮食', icon: '🍬',
    title: '控糖饮食 · 轻负担之选', subTitle: '控糖人群慎选高糖，以下为更友好选择',
    crowds: [toCrowd('高血糖')], preferTags: ['利水消肿'],
    note: '控糖人群食养参考，具体请遵医嘱',
  },
  pregnant: {
    key: 'pregnant', label: '孕产营养', icon: '🤰',
    title: '孕产营养 · 温润之选', subTitle: '为孕期哺乳期优选温润食养好物',
    crowds: [], preferTags: ['补气养血', '滋阴润燥'],
    note: '孕期哺乳期食养参考，具体请遵医嘱',
  },
  sleep: {
    key: 'sleep', label: '助眠安神', icon: '😴',
    title: '助眠安神 · 舒心之选', subTitle: '为睡眠不佳人群优选舒缓食养好物',
    crowds: [toCrowd('失眠')], preferTags: ['舒缓安适'],
  },
  digestion: {
    key: 'digestion', label: '消化调理', icon: '🫗',
    title: '消化调理 · 养胃之选', subTitle: '为肠胃虚弱人群优选健脾消食好物',
