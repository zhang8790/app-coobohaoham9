...
const FAQ_GROUPS = [
  {
    ...
    items: [
      ...
      { q: '下单后多久发货？', a: '门店一般在付款后24小时内发货，节假日可能有所延迟，请耐心等待或联系门店。' },
      { q: '如何取消订单？', a: '待付款状态的订单可直接取消。已付款订单如需取消请在订单页申请退款，等待门店处理。' },
    ]},
  {
    title: '退款售后',
    icon: '⟳',
    items: [
      { q: '如何申请退款？', a: '在"我的订单"中找到对应订单，点击"申请退款"按钮，填写退款原因并提交，等待门店审核处理。' },
    ...
    ]},
  {
    ...
    icon: '💰',
    items: [
      { q: '如何获得推荐奖励？', a: '在"推荐中心"获取您的专属推荐码，将商品或门店码分享给好友，好友通过您的链接购买后即可获得健康豆奖励。' },
      { q: '奖励什么时候发放？', a: '订单完成后7天，推荐奖励以健康豆发放至健康豆余额，可在小程序内消费支付。' },
      { q: '推荐奖励怎么使用？', a: '推荐奖励以健康豆形式发放至健康豆余额，可在小程序内消费支付抵扣，不可提现；健康豆仅用于订单抵扣，不兑现金。' },
    ]},
  {
    title: '账号相关',
    icon: '👤',
    items: [
      ...
      { q: '如何开通自营门店？', a: '在"我的"页面点击"申请开通自营门店"，填写店铺信息后提交申请，审核通过后即可开通门店。' },
    ]},
]
